import { createBucket } from './aws/bucket';
import { createDistribution } from './aws/distribution';
import { createFunction } from './aws/function';
import { createHostedZone } from './aws/hostedZone';
import { createInstance } from './aws/instance';
import { createInstanceProfile } from './aws/instanceProfile';
import { createInternetGateway } from './aws/internetGateway';
import { createInternetGatewayAttachment } from './aws/internetGatewayAttachment';
import { createListener } from './aws/listener';
import { createLoadBalancer } from './aws/loadBalancer';
import { createNatGateway } from './aws/natGateway';
import { createPolicy } from './aws/policy';
import { createRecord } from './aws/record';
import { createRole } from './aws/role';
import { createSecurityGroup } from './aws/securityGroup';
import { createSecurityGroupRuleIngress } from './aws/securityGroupRule';
import { createSubnet } from './aws/subnet';
import { createTarget } from './aws/target';
import { createTargetGroup } from './aws/targetGroup';
import { createVpc } from './aws/vpc';
