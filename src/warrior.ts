...
import { bucketClass } from './aws/bucket';
import { certificateClass } from './aws/certificate';
import { distributionClass } from './aws/distribution';
import { functionClass } from './aws/function';
import { hostedZoneClass } from './aws/hostedZone';
import { instanceClass } from './aws/instance';
import { instanceProfileClass } from './aws/instanceProfile';
import { internetGatewayClass } from './aws/internetGateway';
import { internetGatewayAttachmentClass } from './aws/internetGatewayAttachment';
import { listenerClass } from './aws/listener';
import { loadBalancerClass } from './aws/loadBalancer';
import { natGatewayClass } from './aws/natGateway';
import { policyClass } from './aws/policy';
import { recordClass } from './aws/record';
import { roleClass } from './aws/role';
import { securityGroupClass } from './aws/securityGroup';
import { securityGroupRuleIngressClass } from './aws/securityGroupRule';
import { subnetClass } from './aws/subnet';
import { targetClass } from './aws/target';
import { targetGroupClass } from './aws/targetGroup';
import { vpcClass } from './aws/vpc';
